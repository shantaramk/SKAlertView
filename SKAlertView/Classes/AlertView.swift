...
public class AlertView: UIView, AlertViewModel {
    ...
    public convenience init(title: String, message: String, okButtonText: String, cancelButtonText: String, target: AlertViewDelegate) {
        self.init(frame: UIScreen.main.bounds)
        self.delegate = target
        setupUIView(title: title, message: message, okButtonText: okButtonText, cancelButtonText: cancelButtonText)
    }

    public convenience init(title: String, message: String, okButtonText: String, cancelButtonText: String, actionCompletionHandler: @escaping (String, ButtonType) -> Void) {
        self.init(frame: UIScreen.main.bounds)
